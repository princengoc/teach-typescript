...
// Four moves, handed to you ready-made. You spend them; you may also open them.
// Nothing in here is magic -- it is robot calls under a name. The two new ones
// are the smallest moves there are, and every lesson after this is built out of
// them.
