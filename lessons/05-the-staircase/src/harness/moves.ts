import { robot, wallAhead } from './robot';

// Two moves, handed to you ready-made. You spend them; you may also open them.
// Nothing in here is magic -- it is robot calls under a name, and every line of
// it is a call you have made yourself since lesson 02.
