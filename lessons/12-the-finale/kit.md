...
| `room.midX` | How far across the middle square is. | just this room |
| `room.midY` | How far down the middle square is. | just this room |
| `room.reach` | How far from the middle the diamond reaches. | just this room |
| `room.marks` | The numbers of the squares the picture wants painted. | just this room |
